...
public class EntityProjectionMakerTest {
    ...
    public void testRootCollectionNoQueryParams() {
        ...
        EntityProjection expected = EntityProjection.builder()
                ...
                .attribute(Attribute.builder().parentType(Book.class).name("genre").type(String.class).build())
                .attribute(Attribute.builder().parentType(Book.class).name("language").type(String.class).build())
                .attribute(Attribute.builder().parentType(Book.class).name("publishDate").type(long.class).build())
    ...
    public void testNestedCollectionNoQueryParams() {
        ...
        EntityProjection expected = EntityProjection.builder()
                ...
                .relationship("books", EntityProjection.builder()
                        ...
                        .relationship("publisher", EntityProjection.builder()
                                .type(Publisher.class)
                                .attribute(Attribute.builder().parentType(Publisher.class).name("name").type(String.class).build())
                                .attribute(Attribute.builder().parentType(Publisher.class).name("updateHookInvoked").type(boolean.class).build())
                                .relationship("books", EntityProjection.builder()
                                        .type(Book.class)
                                        .build())
                                .relationship("editor", EntityProjection.builder()
    ...
    public void testRootCollectionWithNestedInclude() throws Exception {
        ...
        EntityProjection expected = EntityProjection.builder()
                ...
                .relationship("books", EntityProjection.builder()
                        ...
                        .relationship("editor", EntityProjection.builder()
                                .type(Editor.class)
                                .attribute(Attribute.builder().parentType(Editor.class).name("firstName").type(String.class).build())
                                .attribute(Attribute.builder().parentType(Editor.class).name("lastName").type(String.class).build())
                                .attribute(Attribute.builder().parentType(Editor.class).name("fullName").type(String.class).build())
                                .relationship("editor", EntityProjection.builder()
                                        .type(Editor.class)
                                        .build())
                                .build())
